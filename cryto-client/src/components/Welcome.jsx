    ...
    <div className="flex w-full justify-center items-center">
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
        <div className="flex flex-1 justify-start items-start flex-col mf:mr-10">
          ...
          Empower Your <br /> Transactions with Ease
          </h1>
          <p className="text-left mt-5 text-black font-light md:w-9/12 w-11/12 text-base">
          Seamlessly Send, Receive, and Trade Cryptocurrency! MetaMask-Powered Exchange - Your Gateway to Effortless Crypto Transactions!
          </p>
          {!currentAccount && (
            <button
              type="button"
            ...
            {isLoading
              ...
              : (
                <button
                  ...
                  className="text-black w-full mt-2 border-[1px] p-2 border-[#060b18] hover:bg-[#7395e5] rounded-full cursor-pointer"
                >
                  Send now
                </button>
              )}
